        ...
        <div className="container-tight relative z-10">
          ...
          <Reveal delay={0.1} className="mt-12">
            <div className="ring-gradient relative aspect-[16/9] w-full overflow-hidden rounded-3xl shadow-glow">
              ...
              />
              <div className="absolute inset-0 bg-[radial-gradient(60%_60%_at_30%_20%,rgba(255,255,255,0.18),transparent),radial-gradient(60%_60%_at_80%_80%,rgba(255,255,255,0.18),transparent)]" />
              <div className="absolute inset-x-8 top-6 rounded-xl border border-white/30 bg-white/10 p-3 backdrop-blur">
                <div className="flex items-center gap-1.5">
                  <span className="h-2 w-2 rounded-full bg-white/50" />
                  <span className="h-2 w-2 rounded-full bg-white/40" />
                  <span className="h-2 w-2 rounded-full bg-white/30" />
                  <span className="ml-2 truncate text-[11px] text-white/80">
                    {r.url.replace(/^https?:\/\//, "")}
                  </span>
                </div>
              </div>
              <div className="absolute inset-x-12 bottom-10 grid grid-cols-3 gap-3">
                {[0, 1, 2].map((i) => (
                  <div
                    key={i}
                    className="h-24 rounded-2xl border border-white/15 bg-white/10 backdrop-blur sm:h-28"
                  />
                ))}
              </div>
            </div>
